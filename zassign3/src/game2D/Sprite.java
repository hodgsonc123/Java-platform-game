...
public class Sprite {
	...
	*/
    ...
    public int getScaledWidth(double scale) {
        return (int)(anim.getImage().getWidth(null) *scale);
    }
    ...
    */
    public int getScaledHeight(double scale) {
        return (int)(anim.getImage().getHeight(null)*scale);
    }
    
//    public int getScaledCoinWidth() {
//        return (int)(anim.getImage().getWidth(null) *0.25);
//    }
//
//    /**
//        Gets this Sprite's height, based on the size of the
//        current image.
//    */
//    public int getScaledCoinHeight() {
//        return (int)(anim.getImage().getHeight(null)*0.25);
//    }
//    
